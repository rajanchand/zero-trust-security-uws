        ...
        <div className="rounded-lg border border-border bg-card p-6">
          {!showChannelPicker ? (
            ...
            <div className="space-y-4">
              ...
              <Button onClick={() => handleChannelSelect('email')} variant="outline" className="w-full h-14 justify-start gap-4">
              ...
              <Button onClick={() => handleChannelSelect('mobile')} variant="outline" className="w-full h-14 justify-start gap-4">
